...
var slides = [
	...
	{ img: "./img/image3.png", txt: "Rub hands palm to palm." },
	{ img: "./img/image4.png", txt: "Right palm over left dorsum with interlaced fingers and vica versa." },
	{ img: "./img/image5.png", txt: "Palm to palm with fingers interlaced." },
	{ img: "./img/image6.png", txt: "Backs of fingers to opposing palms with fingers interlocked." },
	{ img: "./img/image7.png", txt: "Rotational rubbing of left thumb clasped in right palm and vica versa." },
	{ img: "./img/image8.png", txt: "Rotational rubbing, backwards and forwards with clasped fingers of right hand in left palm and vica versa." },
	{ img: "./img/image12.png", txt: "You are ready to take a photo!" }
...
var app = {
	...
	slideShow: function() {
		...
		function nextSlide(index) {
			...
			document.getElementById("slideImg").src = slides[index].img;
			document.getElementById("slideSubtitle").innerHTML = slides[index].txt;
			
			index++;
			if (index < slides.length) {

				app.currentSlideshow = setTimeout(nextSlide, 3000, index);
